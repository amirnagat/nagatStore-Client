    ...
    >
      <div>
        ...
        >
          ...
          <div class="mt-8 flex justify-center gap-0.5 text-yellow-500">
            <svg
      ...
      <div>
        <img
          alt="Woman"
          src="https://media-exp1.licdn.com/dms/image/D4D03AQHbcE_A9X4u2g/profile-displayphoto-shrink_200_200/0/1665574104888?e=1674691200&v=beta&t=cR08CNFuqQU7ZsZTuZA5_1Gbx2J69WKsz4Z2XwrwcRI"
          class="mx-auto h-24 w-24 rounded-full object-cover shadow-xl"
        />
        ...
        <blockquote
          class="-mt-6 flex flex-col justify-between rounded-lg p-12 text-center shadow-xl"
        >
          <p class="text-lg font-bold text-gray-700">Roy Mekonen</p>
          <p class="mt-1 text-xs font-medium text-gray-500">
            Netanya , israel 
          </p>
          <p class="mt-4 text-sm text-gray-500">
      ...
      <div>
        <img
          alt="Woman"
          src="https://i.postimg.cc/vHQy9tfY/1657915171613.jpg"
          class="mx-auto h-24 w-24 rounded-full object-cover shadow-xl"
        />
        ...
        <blockquote
          class="-mt-6 flex flex-col justify-between rounded-lg p-12 text-center shadow-xl"
        >
          <p class="text-lg font-bold text-gray-700">Or Azriya</p>
          <p class="mt-1 text-xs font-medium text-gray-500">
            Lod,Israel
          </p>
          <p class="mt-4 text-sm text-gray-500">
