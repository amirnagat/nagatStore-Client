...
<img className='w-25' src="https://i.postimg.cc/1XT7XPZY/2022-06-30-221634-removebg-preview-1.png" alt="" />
    </div>
...
{/* footer nav */}
    ...
    <ul class="mt-12 flex justify-center gap-6 md:gap-8">
      <li>
        <a
          href="https://www.facebook.com/amir.nagat"
          rel="noreferrer"
          target="_blank"
      ...
      <li>
        <a
          href="https://www.instagram.com/nagat_shirts/"
          rel="noreferrer"
          target="_blank"
          class="text-gray-700 transition hover:text-gray-700/75"
        >
      ...
      <li>
        <a
          href="https://twitter.com/nagat1700"
          rel="noreferrer"
          target="_blank"
          class="text-gray-700 transition hover:text-gray-700/75"
        >
